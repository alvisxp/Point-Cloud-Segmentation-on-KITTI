...
def parse_args(notebook = False):
    ...
    parser.add_argument('--subset', type=str, default='all', choices=('inview', 'all'))
    parser.add_argument('--workers', type=int, default=4, help='number of data loading workers')
    parser.add_argument('--epoch', type=int, default=100, help='number of epochs for training')
    parser.add_argument('--pretrain', type=str, default='experiment/pointnet/pointnet_026.pth', help='whether use pretrain model')
    ...
    parser.add_argument('--sequence', type=str, default='00', help = 'Enter sequence (00-10)')
    if notebook:
